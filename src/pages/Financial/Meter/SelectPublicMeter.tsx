...
interface SelectPublicMeterProps {
  visible: boolean;
  closeModal(): void;
...
const SelectPublicMeter = (props: SelectPublicMeterProps) => {
...
export default Form.create<SelectPublicMeterProps>()(SelectPublicMeter);
