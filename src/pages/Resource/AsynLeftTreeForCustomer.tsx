...
import { GetOrgTree, GetAsynChildBuildingsForCustomer } from '@/services/commonItem';

const { TreeNode } = Tree;
const { Sider } = Layout;

interface AsynLeftTreeForCustomerProps {
  //treeData: any[];
  selectTree(parentId, type, info): void;
  parentid: string;
}

function AsynLeftTreeForCustomer(props: AsynLeftTreeForCustomerProps) {
  ...
  const onLoadData = treeNode =>
    new Promise<any>(resolve => {
      ...
      setTimeout(() => {
        GetAsynChildBuildingsForCustomer(treeNode.props.eventKey, treeNode.props.type).then((res: any[]) => {
...
export default AsynLeftTreeForCustomer;
