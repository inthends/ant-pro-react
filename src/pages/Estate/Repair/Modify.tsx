...
import {
  ...
  PageHeader, Button, Card, Col, Drawer, Form, Input, message, Row, Tabs
} from 'antd';
...
import AddBackMemo from './AddBackMemo';
...
const Modify = (props: ModifyProps) => {
  ...
  const closeAddFee = (feeId, amount) => {
    setFeeId(feeId);
    ...
    if (modifyVisible) {
      ...
      if (id) {
        ...
        GetEntity(id).then(info => {
          ...
          //获取操作记录
          GetOperationRecords(id).then(info => {
            setComments(info || []);
          })
