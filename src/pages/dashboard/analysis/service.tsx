...
export async function fakeChartData() {
  ...
  return {
    ...
    { "index": 17, "keyword": "搜索关键词-16", "count": 994, "range": 37, "status": 1 },
    { "index": 18, "keyword": "搜索关键词-17", "count": 386, "range": 22, "status": 1 },
    { "index": 19, "keyword": "搜索关键词-18", "count": 144, "range": 76, "status": 0 },
    { "index": 20, "keyword": "搜索关键词-19", "count": 47, "range": 25, "status": 1 }],
    "offlineData": [{ "name": "管理处 0", "cvr": 0.2 },
    { "name": "管理处 1", "cvr": 0.4 },
    { "name": "管理处 2", "cvr": 0.8 },
    { "name": "管理处 3", "cvr": 0.5 },
    { "name": "管理处 4", "cvr": 0.6 },
    ...
    { "name": "管理处 8", "cvr": 0.1 },
    { "name": "管理处 9", "cvr": 0.1 }],
    "offlineChartData": [{ "x": 1566541196496, "y1": 53, "y2": 64 },
