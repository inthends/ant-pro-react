...
interface LeaseTermRenewalProps {
...
//合同续租动态数量
let index = 1;
function LeaseTermRenewal(props: LeaseTermRenewalProps) {
          ...
          <Col lg={4}>
            <Form.Item label="开始时间" required >
              {getFieldDecorator(`startDate[0]`, { 
                initialValue: moment(form.getFieldValue('billingDate')),
                rules: [{ required: true, message: '请选择开始时间' }],
              })(<DatePicker placeholder='请选择开始时间' />)}
            </Form.Item>
          </Col>
          <Col lg={4}>
            <Form.Item label="结束时间" required>
              {getFieldDecorator(`endDate[0]`, {
                initialValue: moment(form.getFieldValue('billingDate')).add(1, 'years'),
                rules: [{ required: true, message: '请选择结束时间' }],
              })(<DatePicker placeholder='请选择结束时间' />)}
            </Form.Item>
          </Col>
...
export default LeaseTermRenewal;
