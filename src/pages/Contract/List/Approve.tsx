...
import { Spin, Upload, Tooltip, Input, message, Tag, Divider, PageHeader, List, Tabs, Button, Card, Col, Drawer, Form, Row } from 'antd';
...
import { GetFilesData, GetChargeByContractId, GetContractInfo } from './Main.service';
