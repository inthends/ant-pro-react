...
export interface SettingDrawerProps {
  settings: MergerSettingsType<DefaultSettings>;
  collapse?: boolean;
  // for test
  getContainer?: any;
  onCollapseChange?: (collapse: boolean) => void;
  onSettingChange?: (settings: MergerSettingsType<DefaultSettings>) => void;
}

export interface SettingDrawerState extends MergerSettingsType<DefaultSettings> {
  collapse?: boolean;
  language?: string;
}
...
class SettingDrawer extends Component<SettingDrawerProps, SettingDrawerState> {
  ...
  changeSetting = (key: string, value: string | boolean) => {
    ...
    this.setState(nextState, () => {
      ...
      if (onSettingChange) {
        onSettingChange(this.state as MergerSettingsType<DefaultSettings>);
      }
    });
  };
